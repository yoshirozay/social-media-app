...
//import Combine
//
//struct OpenedPostRegularPhones: View {
...
////                                }else
//                                if let webLink =  friendsDictionary.friendsDictionary[id]?.webLink{
...
//                                let placeholderImage = Image(uiImage: CacheImage.placeholderImage)
...
//                                        comments.rawReplyComment = rawReplyComment//                                        replyFun ction.replyToComment(sentBy: Auth.auth().currentUser!.uid,
////                                                                     comment: message,
////                                                                     commentID: commentID,
////                                                                     postID: postData.postID,
...
//                    .padding(.bottom, phoneHeight < 800 ? -35 : 0)
//                    
