...
//    func hasNotAnimated(postID: String) -> Bool {
//        if let _ = loadedPostIDs[postID] {
//            return false
//        } else {
//            return true
//        }
...
//        for item in loadingPagePosts {
//            loadedPostIDs[item.postID] = item.postID
    ...
    if let lastTime = lastTime ,
        ...
        DispatchQueue.main.async {
            if self.isFirstPage {
                ...
                if self.postInfoValues.count < 12 {
