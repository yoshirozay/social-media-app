...
[Case study](docs/index.html) · [App Store](https://apps.apple.com/ca/app/speakez/id1558577008) · [Kickstarter](https://www.kickstarter.com/projects/carsonosullivan/speakez-redefining-social-media) · 4.8 from 44 ratings · still listed

The case study site lives in `docs/`. On GitHub, turn on Pages from the `/docs` folder.
