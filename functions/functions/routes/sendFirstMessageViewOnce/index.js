...
const sendFirstMessage = require("../../services/Messages");

exports.sendFirstMessageViewOnce = functions.https.onCall((messageInformation) => {
  /**
  ...
  return loadMessage()
      .then(() => {
        ...
        sendFirstMessage.createViewOnce({newMessageInformation})
