...
const removeFromEvent = require("../../services/Events");

exports.removeFromEvent = functions.https.onCall((eventInformation) => {
  /**
     * Returns post data
  ...
  return loadData()
      .then(() => {
        ...
        removeFromEvent.removeFromEvent({newEventInformation})
