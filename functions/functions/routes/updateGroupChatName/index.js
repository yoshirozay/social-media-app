...
const updateGroupChatName = require("../../services/Messages");

exports.updateGroupChatName = functions.https.onCall((messageInformation) => {
  /**
  ...
  return loadMessage()
      .then(() => {
        ...
        messageInformation["users"].forEach((item) => {
          ...
          updateGroupChatName.updateGroupChatName({newMessageInformation})
