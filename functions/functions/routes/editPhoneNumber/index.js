...
const editPhoneNumber = require("../../services/Profile");


exports.editPhoneNumber = functions.https.onCall((profileInformation) => {
  /**
  ...
  return loadData()
      .then(() => {
        ...
        editPhoneNumber.editPhoneNumber({newProfileInformation})
