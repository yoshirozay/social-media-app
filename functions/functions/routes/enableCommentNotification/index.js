...
const enableCommentNotification = require("../../services/Settings");


exports.enableCommentNotification = functions.https.onCall((userInformation) => {
  /**
  ...
  return loadData()
      .then(() => {
        ...
        enableCommentNotification.enableCommentNotification({newUserInformation})
