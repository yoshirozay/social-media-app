...
const cancelEventInvitation = require("../../services/Events");

exports.cancelEventInvitation = functions.https.onCall((eventInformation) => {
  /**
     * Returns post data
  ...
  return loadData()
      .then(() => {
        ...
        cancelEventInvitation.cancelEventInvitation({newEventInformation})
