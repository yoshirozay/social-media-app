...
const isNotTypingInOC = require("../../services/Messages");

exports.isNotTypingInOC = functions.https.onCall((messageInformation) => {
  /**
  ...
  return loadData()
      .then(() => {
        messageInformation.forEach((item) => {
          ...
          isNotTypingInOC.isNotTypingInOC({newMessageInformation})
