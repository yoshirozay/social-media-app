...
const disableCommentNotification = require("../../services/Settings");


exports.disableCommentNotification = functions.https.onCall((userInformation) => {
  /**
  ...
  return loadData()
      .then(() => {
        ...
        disableCommentNotification.disableCommentNotification({newUserInformation})
