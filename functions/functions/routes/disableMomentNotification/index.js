...
const disableMomentNotification = require("../../services/Settings");


exports.disableMomentNotification = functions.https.onCall((userInformation) => {
  /**
  ...
  return loadData()
      .then(() => {
        ...
        disableMomentNotification.disableMomentNotification({newUserInformation})
