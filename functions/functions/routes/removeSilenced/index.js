...
const removeSilenced = require("../../services/Profile");

exports.removeSilenced = functions.https.onCall((silenceInformation) => {
  /**
  ...
  return loadData()
      .then(() => {
        ...
        removeSilenced.removeSilenced({newSilenceInformation})
